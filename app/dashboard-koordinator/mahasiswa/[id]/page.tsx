      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="rounded-md bg-gray-50 p-4">
            ...
            <p className="font-semibold">{student.id_program_mbkm}</p>
          </div>

          {/* Dosen Pembimbing */}
          <div className="rounded-md bg-gray-50 p-4">
            <p className="text-sm text-gray-500">NIP Dosen Pembimbing</p>
            <p className="font-semibold">{student.NIP_dosbing}</p>
          </div>
          ...
          <div className="rounded-md bg-gray-50 p-4">
            ...
            <p className="font-semibold">{student.prodi || '-'}</p>
          </div>
        </div>
      </div>
    </PageContainer>
